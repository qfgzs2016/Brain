...
window.alert = function (text) {
    ...
    <div id="windowAlertModal" class="modal hide fade" tabindex="-1" role="dialog" aria-hidden="true"> \
      ...
      <div class="modal-footer"> \
        <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">确定</button> \
      </div> \
    </div> \
    ');
        return true;
...
window.confirm = function (text, cb) {
    var initTemplate = function () {
        ...
        <div id="windowConfirmModal" class="modal hide fade" tabindex="-1" role="dialog" aria-hidden="true"> \
          ...
          <div class="modal-footer"> \
            <button class="btn btn-primary" data-dismiss="modal" aria-hidden="true">是</button> \
            <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">否</button> \
          </div> \
        </div> \
      ');
    }
